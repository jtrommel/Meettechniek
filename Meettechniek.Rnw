...
E (GPa) \\
\hline
$\Sexpr{round(Meetwaarden$E[1],3)}$ \\
$\Sexpr{round(Meetwaarden$E[2],3)}$ \\
$\Sexpr{round(Meetwaarden$E[3],3)}$ \\
$\Sexpr{round(Meetwaarden$E[4],3)}$ \\
$\Sexpr{round(Meetwaarden$E[5],3)}$ \\
$\Sexpr{round(Meetwaarden$E[6],3)}$ \\
$\Sexpr{round(Meetwaarden$E[7],3)}$ \\
$\Sexpr{round(Meetwaarden$E[8],3)}$ \\
\hline
$\Sexpr{round(mean(Meetwaarden$E),3)}$
\label{tab:E}
\end{tabular}
...
E (GPa) \\
\hline
$\Sexpr{signif(Meetwaarden$E[1],2)}$ \\
$\Sexpr{signif(Meetwaarden$E[2],2)}$ \\
$\Sexpr{signif(Meetwaarden$E[3],2)}$ \\
$\Sexpr{signif(Meetwaarden$E[4],2)}$ \\
$\Sexpr{signif(Meetwaarden$E[5],2)}$ \\
$\Sexpr{signif(Meetwaarden$E[6],2)}$ \\
$\Sexpr{signif(Meetwaarden$E[7],2)}$ \\
$\Sexpr{signif(Meetwaarden$E[8],2)}$ \\
\hline
$\Sexpr{signif(mean(Meetwaarden$E),2)}$
...
\hline
10,02 & 10,1 & 10,0 & 0,1 & 1\\
20,04 & 19,7 & 20,0 & 0,3 & 1,5\\
30,01 & 29,7 & 30,0 & 0,3 & 1\\
40,08 & 39,8 & 40,0 & 0,2 & 0,5\\
